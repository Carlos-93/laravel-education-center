...
<body class="font-sans antialiased min-h-screen">
    <div class="bg-hero-home h-full">
        ...
        <main class="flex flex-col h-[37.8rem]">
    ...
    <section class="flex justify-center items-center font-bold py-5 gap-32">
        <article class="flex flex-col items-center gap-2">
            <p class="text-yellow-400 text-5xl">15K</p>
            <p class="text-md">Happy Customers</p>
        </article>
        <article class="flex flex-col items-center gap-2">
            <p class="text-yellow-400 text-5xl">150K</p>
            <p class="text-md">Monthly Visitors</p>
        </article>
        <article class="flex flex-col items-center gap-2">
            <p class="text-yellow-400 text-5xl">15</p>
            <p class="text-md">Countries Worldwide</p>
        </article>
        <article class="flex flex-col items-center gap-2">
            <p class="text-yellow-400 text-5xl">100+</p>
            <p class="text-md">Top Partners</p>
        </article>
    </section>
</body>
